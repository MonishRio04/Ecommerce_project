    ...
    <table class="items-table table-auto ml-4">      
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span style="font-family: DejaVu Sans; sans-serif;">₹</span> {{ !empty($orders['discount']) ? $orders['discount'] : $orders['price'] }}</td>
        </tr>
        @php
        ...
        <tr>
          <td></td>
          <td></td>
          <td class="total">Total :<span style="font-family: DejaVu Sans; sans-serif;">₹</span> {{ $total }}</td>
        </tr>
      </tbody>
    </table>
