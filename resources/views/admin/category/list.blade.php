            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <h4 style="margin-top:10px;padding:10px"
                            class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">
                            Categories List <a href="{{ route('category.create') }}"class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg
