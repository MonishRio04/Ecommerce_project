            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    {{-- <form action="{{ route() }}" method="post"> --}}
                        {!! Form::open(['method'=>'PUT','url'=>route('customer.update',$user->id),'files'=>true,'enctype'=>'multipart/form-data']) !!}
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            {!! Form::select('role',$userrole, $user->role , ["class" => "block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"])!!}
                            @error('role')
                            <p style="color:red;font-size:12px">{{ '*'.$message }}</p>
                            @enderror
                        </label><br>
