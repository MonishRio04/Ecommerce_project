...
<div class="offcanvas-body">
    <div class="order-md-last">
        ...
        <form role="search" method="POST" class="d-flex"  action="{{ url('search') }}">
            <div class="d-flex mt-3 gap-0" role="newsletter">
                @csrf
                <input class="form-control form-control-lg rounded-start rounded-0 bg-light" type="text" name="searchquery" 
    ...
    <div class="container-fluid">
        <div class="row py-3 border-bottom">
            ...
            <div class="col-sm-4 col-lg-3 text-center text-sm-start">
                <div class="main-logo">
                    <a href="{{ url('/') }}">
                        <img src="https://authorselvi.com/wp-content/uploads/2022/01/as-logo1.svg" alt="logo" style="margin-top:20px" 
                        class="img-fluid">
                    </a>
                </div>
            </div>
            ...
            <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
                <div class="search-bar row bg-light p-2 my-2 rounded-4" style="width:120%;margin-top:15px">
                    ...
                    <div class="support-box text-end d-none d-xl-block" style="margin-bottom:20px">
                        ...
                        <h5 class="mb-0" style="font-size:medium">+980-34984089</h5>
                    </div>
{{-- <div class="dropdown">
...
@if(Auth::check())
<li class="d-lg-none">
    <a href="{{ url('cart') }}" class="rounded-circle bg-light p-2 mx-1 text-dark">
    <svg width="24" height="24" viewBox="0 0 24 24">
...
<div class="cart text-end d-none d-lg-block dropdown">
    <a class="border-0 bg-transparent text-decoration-none text-dark" href="{{ url('cart') }}" >
        ...
        <h5 class="mb-0"><span class="cart-total"> <i class="fa fa-shopping-cart" style="font-size:25px"></i>
