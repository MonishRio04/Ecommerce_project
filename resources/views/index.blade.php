                    ...
                    <ul class="list-group mb-3">
                        ...
                        @foreach ($cartitems as $cart)
                            <li class="list-group-item d-flex justify-content-between lh-sm">
                                ...
                                {{-- <div class="offcanvas-header "{{ url('product/' . $product->urlslug) }}"justify-content-center"> --}}
                    ...
                    @if (Auth::check())
                        <div class="cart text-end d-none d-lg-block dropdown">
                            <button class="border-0 bg-transparent" type="button" data-bs-toggle="offcanvas"
                                ...
                                <h5 class="mb-0"><span class="cart-total"> <svg style="height:25px;width:25px"
                                 xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bucket" viewBox="0 0 16 16">
                                <path id="cart-items-container" d="M2.522 5H2a.5.5 0 0 0-.494.574l1.372 9.149A1.5 1.5 0 0 0 4.36 16h7.278a1.5 1.5 0 0 0 1.483-1.277l1.373-9.149A.5.5 0 0 0 14 5h-.522A5.5 5.5 0 0 0 2.522 5zm1.005 0a4.5 4.5 0 0 1 8.945 0H3.527zm9.892 1-1.286 8.574a.5.5 0 0 1-.494.426H4.36a.5.5 0 0 1-.494-.426L2.58 6h10.838z"/></svg>
                                            ...
                                            <div class="product-item">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <button type="button" id="button_{{ $product->id }}"
                                                        href="#" class="add-to-cart nav-link">Add to Cart
                                        ...
                                        $('.add-to-cart').click(function() {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(response) {
                                                    // alert(response);
                                                    parent.find('.add-to-cart').text('Added to cart');
                                                    ...
                                                    // console.log(response);
                                                        ...
                                                        // $('#price').text(response[i].product_price)
                                                        // $('#pname').text(response[i].product_name)
