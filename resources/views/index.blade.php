      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-3 text-center text-sm-start">
            <div class="main-logo">
              <a href="index.html">
                <img src="https://authorselvi.com/wp-content/uploads/2022/01/as-logo1.svg" alt="logo" class="img-fluid">
              </a>
            </div>
          </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src='storage/productImages/{{ $newItem->image }}' class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                ...
                @foreach($products as $product)
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="{{ url('product/'.$product->urlslug) }}" title="Product Title">
                            <img src="storage/productImages/{{ $product->image }}"  class="tab-image">
                          </a>
                        </figure>
                        <h3>{{ $product->name }}</h3>
